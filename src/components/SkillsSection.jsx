...
const skills = [
    ...
    {name: "R", level: 75, category: "database"},
    {name: "ERD", level: 80, category: "database"},
    {name: "Database Normalization", level: 85, category: "database"},
    {name: "SQL", level: 90, category: "database"},
    {name: "Python", level: 75, category: "database"},
